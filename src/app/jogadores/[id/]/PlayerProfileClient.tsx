...
export default function PlayerProfileClient({ player: p, pointsTotal }: Props) {
  ...
  const currentWeekPoints = p.weekly_evolution?.length ? p.weekly_evolution[p.weekly_evolution.length - 1].points : 0;
